...
struct ThreadCheckerTestView: View {
                ...
                VStack(spacing: 15) {
                    ...
                    HStack(spacing: 15) {
                        ...
                        Button("Disable ThreadChecker") {
                            DebugSwift.Performance.ThreadChecker.disable()
                    ...
                    HStack(spacing: 15) {
                        Button("Enable Auto-Fix") {
                            DebugSwift.Performance.ThreadChecker.enableAutoFix()
                        ...
                        Button("Clear Violations") {
                            DebugSwift.Performance.ThreadChecker.clearViolations()
    ...
    private func testManualCheckMainThread() {
        ...
        DebugSwift.Performance.ThreadChecker.shared.checkMainThread(
