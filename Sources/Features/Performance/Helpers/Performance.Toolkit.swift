...
class PerformanceToolkit {
    ...
    var currentMeasurementIndex: Int = 0
    let measurementsLimit: Int = 120
    ...
    func simulateMemoryWarning() {
        let keyData = Data([0x5f, 0x70, 0x65, 0x72, 0x66, 0x6f, 0x72, 0x6d, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x57, 0x61, 0x72, 0x6e, 0x69, 0x6e, 0x67])
