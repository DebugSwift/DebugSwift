...
public final class SnapshotViewConfiguration: NSObject {
    ...
    @objc public var minimumZSpacing: Float = .zero

    /// The maximum spacing between layers on the z-axis.
    @objc public var maximumZSpacing: Float = 100
    ...
    /// is selected.
    @objc public var highlightColor = UIColor(red: .zero, green: .zero, blue: 1.0, alpha: 0.5)
